...
$router->get('/admin/questions/exclusions', [QuestionExclusionController::class, 'index']);
$router->post('/admin/questions/exclusions', [QuestionExclusionController::class, 'index']);
$router->get('/admin/questions/import', [QuestionImportController::class, 'index']);
$router->post('/admin/questions/import', [QuestionImportController::class, 'index']);
$router->get('/admin/questions/template', [QuestionExportController::class, 'template']);
$router->get('/admin/questions/export', [QuestionExportController::class, 'export']);
$router->get('/admin/questions/reference', [QuestionExportController::class, 'reference']);
