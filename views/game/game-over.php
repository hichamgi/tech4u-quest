...
<?php elseif ($attempt): ?>
    <section class="card result-box">
        ...
        <h1>GAME OVER</h1>
        <p>Tu as épuisé tes vies. Ton score est enregistré. Lors de la nouvelle tentative, les questions déjà rencontrées seront régénérées autant que possible, tandis que les questions futures seront conservées.</p>
