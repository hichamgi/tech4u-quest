...
<title><?= htmlspecialchars((string)$config['app_name'], ENT_QUOTES, 'UTF-8') ?> — Apprendre en jouant</title>
...
<nav class="nav-links"><a class="nav-link active" href="./">Accueil</a><a class="nav-link" href="login">Connexion</a><a class="btn btn-primary" href="login">Commencer la quête →</a></nav>
</div></header>
...
<div class="hero-actions"><a class="btn btn-primary" href="login">🚀 Démarrer</a></div>
