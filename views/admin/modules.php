...
?>
<div class="page-head"><div><span class="eyebrow">🧭 CONFIGURATION PÉDAGOGIQUE</span><h1>Modules et réglages</h1><p>Active les modules déjà traités en classe, puis règle les catégories et les quatre niveaux de difficulté. Toutes les tentatives utilisent 3 vies.</p></div></div>
